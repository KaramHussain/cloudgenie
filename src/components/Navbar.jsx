...
const Navbar = () => {
  ...
  return (
    <nav className='w-full flex py-1 justify-between items-center navbar -mt-20 -ml-20'> {/* Adjusted padding */}
      <img src={logo} alt='hoobank' className='w-[410px] h-[250px] object-contain' /> {/* Adjusted size and added object-contain */}
